...
df_types_including_null = df[['primary_type', 'secondary_type']].copy()
...
def display_subchart(click_data):
    ...
    filtered_df = df_types_including_null[(df_types_including_null['primary_type'] == selected_type) | (df_types_including_null['secondary_type'] == selected_type)]
